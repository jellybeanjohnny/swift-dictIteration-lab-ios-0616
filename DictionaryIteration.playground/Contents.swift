 ...
 */
// write your code here
highestSellingAlbums["The Pixies"] = "Doolittle"
 ...
 */
// Make a dictioanry where the keys are ABCDF and the values are the number of students who got that grade
